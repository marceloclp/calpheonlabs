...
| `rows[].repeatedExchangeGroupId` | row `+4..+7`; positive `u32`         | retained                               | payload copy of the exchange-group identity               | Certain             | Certain                   | High                | Full-capture comparison agrees for every row and all 200 offset-directory keys                                | Closed         |
...
| repeated-key relationship        | complete 197-byte row                | both values retained; no runtime check | both serialized group identities agree in the capture     | Certain             | Certain                   | Certain             | Full-capture comparison has zero mismatches                                                                   | Closed         |
