...
| IMLO-02 | The migrated BSD output is exactly reference-equivalent after retaining the table token and footer pointer. | Full directory-order comparison matched `magic`, 29,204 rows, and footer offset 350,456 with digest `e34351e920ace40ff66d1f29f269362b253eac33f79be315c573444d9bbb1f6c`. | The transformed oracle retains every emitted non-byte value.                    | Closed |
