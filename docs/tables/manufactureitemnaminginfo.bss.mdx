---
title: "manufactureitemnaminginfo.bss"
description: "Binary layout, byte coverage, field semantics, and validation evidence for the intrinsic BSD manufactureitemnaminginfo decoder."
sidebar:
    label: "manufactureitemnaminginfo.bss"
    icon: database
search:
