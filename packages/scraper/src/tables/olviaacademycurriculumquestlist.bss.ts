...
export const OlviaAcademyCurriculumQuestListBss = table({
    path: "gamecommondata/binary/olviaacademycurriculumquestlist.bss",
    pabr: true,
    rows: {
...
if (import.meta.main) {
    await OlviaAcademyCurriculumQuestListBss.decodeIntoDisk({ debug: true });
}
