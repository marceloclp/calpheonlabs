...
/** One physical mapping from a quest to two entries in the following string pool. */
...
const QuestJournalVideoInfoBss = bss("gamecommondata/binary/questjournalvideoinfo.bss")({
